...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyaml-env-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13496&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyaml-env-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyaml-env` can be installed with:

```
conda install pyaml-env
```

It is possible to list all of the versions of `pyaml-env` available on your platform with:
